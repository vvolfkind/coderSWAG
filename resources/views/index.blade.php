...
@section('contenido')
		<!-- About -->
		<article id="about" class="about row">
				...
				<div class="col-sm-12 testimonials">
					<div class="row">
						...
						<article class="col-md-4 text-center">
							<img class="imgtestimonio img-circle" src="customers/26101432.jpeg">
							<h4><i><q>Me ceba eh! Como diria Agus... MUY ASTUTO!</q></i></h4>
						</article>
						<article class="col-md-4 text-center">
							<img class="imgtestimonio img-circle" src="customers/turdferguson.jpg">
							<h4><i><q>Small Towns for $200</q></i></h4>
						</article>
					</div>	
				</div>
